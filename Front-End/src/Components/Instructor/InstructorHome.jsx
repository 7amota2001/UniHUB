        ...
        <div class="w-full px-10 py-6 mx-auto loopple-min-height-78vh text-slate-500">
            ...
            <div className="overflow-x-auto">
                ...
                <div class="w-full max-w-full px-3 mb-6 lg:w-4/12 sm:flex-none xl:mb-0">
                        ...
                        <div class="flex items-end flex-auto py-8 pt-0 px-9 ">
                            ...
                            <div class="flex flex-col items-center w-full mt-3">
                                ...
                                <div class="flex justify-between w-full mt-auto mb-2 font-semibold text-dark text-lg/normal">
                                    <span class="mr-4 text-dark">Total Users {instructorStatistics2 && instructorStatistics2.totalStudentCount}</span>
                                    <span>{instructorStatistics && instructorStatistics2 && instructorStatistics2.totalStudentCount/instructorStatistics.courseCount}%</span>
                                </div>
                    ...
                    {/* <!-- end card body  --> */}
                    <div>
    <h3 className="font-bold mb-5 text-2xl">Tasks</h3>
...
<div className="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30 ">
              <div className="flex flex-col justify-between flex-auto py-8 px-9">
                ...
                <button 
                  ...
                  className="bg-blue-500 hover:bg-blue-700 text-black font-bold py-2 px-4 rounded text-xl chatbotcolor "
                >
                    <FontAwesomeIcon icon={faRobot} className="mr-2 text-2xl chatbotcolor" />
                  Ai Assistant ?
                </button>
                {isChatbotVisible && (
